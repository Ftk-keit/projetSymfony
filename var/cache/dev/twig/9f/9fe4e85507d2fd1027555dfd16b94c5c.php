...
class __TwigTemplate_83c74e464f94f59ddba49915f21d8a86 extends Template
{
    ...
    ";
        ...
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 7, $this->source); })())) {
            ...
            ";
            // line 9
            yield $this->extensions['Symfony\Bridge\Twig\Extension\DumpExtension']->dump($this->env, $context, (isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 9, $this->source); })()));
            yield "
        </pre>
        <pre>
            ";
            // line 12
            yield $this->extensions['Symfony\Bridge\Twig\Extension\DumpExtension']->dump($this->env, $context, (isset($context["last_username"]) || array_key_exists("last_username", $context) ? $context["last_username"] : (function () { throw new RuntimeError('Variable "last_username" does not exist.', 12, $this->source); })()));
            yield "
        </pre>
    ...
    <input type=\"text\" value=\"";
        ...
        yield "\" name=\"login\" id=\"inputEmail\" class=\"form-control\" autocomplete=\"login\" required autofocus>
...
";
    ...
    {
        return array (  153 => 30,  145 => 25,  140 => 22,  132 => 19,  129 => 18,  127 => 17,  124 => 16,  119 => 14,  114 => 12,  108 => 9,  105 => 8,  103 => 7,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
<form method=\"post\">
    ...
    <h1 class=\"h3 mb-3 font-weight-normal\">Please sign in</h1>
    <label for=\"inputLogin\">Login</label>
    <input type=\"text\" value=\"{{ last_username }}\" name=\"login\" id=\"inputEmail\" class=\"form-control\" autocomplete=\"login\" required autofocus>
    <label for=\"inputPassword\">Password</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" autocomplete=\"current-password\" required>
