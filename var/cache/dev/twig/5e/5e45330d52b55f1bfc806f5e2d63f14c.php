...
class __TwigTemplate_f7154c7908d1c847ab8aa9be1552829e extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        yield "\" onsubmit=\"return confirm('Are you sure you want to delete this user?');\" class=\"mt-4\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this user?');\" class=\"mt-4\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline\">Delete</button>
</form>

", "user/_delete_form.html.twig", "/home/fatima/Documents/symfony/gestBoutique_Symfony/templates/user/_delete_form.html.twig");
    }
}
