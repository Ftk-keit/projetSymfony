...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Form\\DetailArticleDetteFormType' => ['privates', 'App\\Form\\DetailArticleDetteFormType', 'getDetailArticleDetteFormTypeService', true],
            'App\\Form\\DetteFilterType' => ['privates', 'App\\Form\\DetteFilterType', 'getDetteFilterTypeService', true],
            'App\\Form\\DetteFormType' => ['privates', 'App\\Form\\DetteFormType', 'getDetteFormTypeService', true],
            'App\\Form\\DetteSearchFormType' => ['privates', 'App\\Form\\DetteSearchFormType', 'getDetteSearchFormTypeService', true],
            'App\\Form\\PayementType' => ['privates', 'App\\Form\\PayementType', 'getPayementTypeService', true],
            'App\\Form\\SearchClientFormType' => ['privates', 'App\\Form\\SearchClientFormType', 'getSearchClientFormTypeService', true],
            'App\\Form\\UploadType' => ['privates', 'App\\Form\\UploadType', 'getUploadTypeService', true],
            ...
            'App\\Form\\DetailArticleDetteFormType' => '?',
            'App\\Form\\DetteFilterType' => '?',
            'App\\Form\\DetteFormType' => '?',
            'App\\Form\\DetteSearchFormType' => '?',
            'App\\Form\\PayementType' => '?',
            'App\\Form\\SearchClientFormType' => '?',
            'App\\Form\\UploadType' => '?',
